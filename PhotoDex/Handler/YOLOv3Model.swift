...
class YOLOv3Model {
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let imageClassificationRequest = VNCoreMLRequest(model: YOLOv3Model.imageClassifier, completionHandler: visionRequestHandler)
    ...
    private func visionRequestHandler(_ request: VNRequest, error: Error?) {
        ...
        predictions = observations.map { observation in
            ...
            Prediction(clasiffication: observation.identifier,
                       confidencePercentage: observation.confidence.formatted())
        }
    }
}
